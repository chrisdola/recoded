...
export default function Header({
  ...
  const recordButtonText =
    exportingGIF || allGIFFramesCaptured ? "Saving" : "Export VID";
  return (
      ...
      <header className="header">
        <div className="header__part">
          ...
          <NumberInput
            ...
            testid="vertical-padding-input"
          />
          <NumberInput
            name="Horizontal Padding"
            value={paddingHorizontal}
            onChange={setHorizontalPadding}
            testid="horizontal-padding-input"
          />
          <NumberInput
            name="Frame Duration"
            value={frameDuration}
          ...
          <SelectInput
            ...
            value={font}
            onChange={setFont}
            options={FONTS.map((f) => Object.keys(f)[0])}
            testid="font-select"
          />
          <BackgroundColorInput
            value={backgroundColor}
            onChange={setBackgroundColor}
            testid="background-color-select"
          />
